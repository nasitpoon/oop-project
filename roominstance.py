...
for i in range(100):
    ...
    room_Chaophraya_list.append(room_Chaophraya)

room_Chaophraya_available_list = [room for room in room_Chaophraya_list if not room.get_reserved()]
...
room_Deluxe1bedroomSuite = Room(name = "Deluxe One-Bedroom Theme Suite",
                                  type = "Suite",
                                  room_number = 0,
                                  bed_type = "King Bed or Twin Beds",
                                  size = "83SQM / 892SQF",
...
room_Deluxe2bedroomSuite = Room(name = "Deluxe Two-Bedroom Theme Suite",
                                  type = "Suite",
                                  room_number = 0,
...
room_Premier1bedroom = Room(name = "Premier 1-Bedroom Suite",
                              type = "Suite",
                              room_number = 0,
                              bed_type = "King Bed or Twin Beds",
...
room_Premier2bedroomSuite = Room(name = "Premier 2-Bedroom Suite",
                                  type = "Suite",
                                  room_number = 0,
                                  bed_type = "King and Twin Beds or Twin and Twin Beds",
                                  size = "83SQM / 892SQF",
...
room_Ambassador2bedroomSuite = Room(name = "Ambassador 2-Bedroom Suite",
                                     type = "Suite",
                                     room_number = 0,
...
room_Oriental2bedroomSuite = Room(name = "Oriental 2-Bedroom Suite",
                                   type = "Suite",
                                   room_number = 0,
                                   bed_type = "King or Twin Beds",
